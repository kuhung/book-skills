...
- **格式要求**（参照已有文件 `notes/说服的艺术_笔记.md` 的格式）:
  ...
  - **必含"残差标记"章节**：残差是一种设计哲学——AI 对书的压缩是有损的，损掉的正是读者的个人视角。本章节在社区共识（热门划线）的基线之上，标记出"我"额外圈出的增量：我特别标记而共识未覆盖的关注点、我的想法对共识的补充与延伸；如有存疑或分歧可少量记录，但不追求对抗性，核心公式是"共识 + 我的增量 = 我的理解"
